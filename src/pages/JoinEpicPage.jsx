...
const JoinEpicPage = () => {
  ...
  // Already signed in? Join Epic is the same as account sign-up — go to account.
  useEffect(() => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Carry email + phone + country so the OTP page can verify both.
      saveJoinDetails({ ...form, phone, country });
