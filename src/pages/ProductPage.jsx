      ...
      <section className="relative px-8 pb-24 pt-32 md:px-12">
        ...
        <div className="mx-auto grid max-w-[1340px] gap-12 md:grid-cols-2">
          ...
          <div className="pt-10">
            ...
            <Link to="/wear-epic/cart" className="mt-10 inline-flex rounded-full bg-[#154527] px-12 py-4 text-xs font-bold uppercase text-[#fff4a8]">Add to cart</Link>
          </div>
        </div>
      </section>
      <section className="px-8 pb-24 md:px-12"><div className="mx-auto max-w-[1340px]"><ProductGrid products={products} /></div></section>
      <SiteFooter />
    </main>
  );
};
